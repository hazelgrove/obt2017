...
\newcommand{\pval}[1]{{#1} ~\mathbf{value}}
\newcommand{\pindet}[1]{{#1} ~\mathbf{indet}}
\newcommand{\pfinal}[1]{{#1} ~\mathbf{final}}
\newcommand{\pstep}[2]{{#1} \longmapsto {#2}}
...
\newcommand{\tehole}[1]{\llparenthesiscolor\rrparenthesiscolor_{#1}}
\newcommand{\tsum}[2]{{#1} + {#2}}
...
\newcommand{\hehole}[1]{\llparenthesiscolor\rrparenthesiscolor_{#1}}
\newcommand{\hhole}[2]{\llparenthesiscolor#1\rrparenthesiscolor_{#2}}
